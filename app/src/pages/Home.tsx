    ...
    <div className="px-[8%] xl:px-[16%] py-6">
      ...
      <div className="py-12 mt-12 xl:mt-0 flex flex-col xl:flex-row items-center xl:justify-between">
        ...
        <div className="w-full xl:w-1/2 mt-12 xl:px-12 xl:mt-0">
          <h2 className="text-4xl md:text-5xl text-center xl:text-start font-bold text-[#6a483c] mb-4">Rreth Nesh</h2>
      ...
      <div className="flex flex-col xl:flex-row items-center justify-between my-12">
        <div className="w-full xl:w-1/2 flex flex-col space-y-6">
          <h2 className="text-4xl md:text-5xl text-center xl:text-start font-bold text-[#6a483c] mb-4">Depilim me Laser</h2>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-3 gap-4">
            <div className="flex flex-col items-center py-8 space-y-4 p-2 bg-transparent shadow-md hover:shadow-lg transition-shadow border border-[#6a483c] duration-300 h-48">
              <img src={body} alt="Face Waxing" className="w-16 h-16 object-contain rounded-md mb-2" />
              <h3 className="text-lg font-bold text-[#6a483c] mb-1">Komplet Trupi</h3>
            </div>

            <div className="flex flex-col items-center py-8 space-y-4 p-2 bg-transparent shadow-md hover:shadow-lg transition-shadow border border-[#6a483c] duration-300 h-48">
              <img src={fytyra} alt="Body Waxing" className="w-16 h-16 object-contain rounded-md mb-2" />
            ...
            <div className="flex flex-col items-center p-2 py-8 space-y-4 shadow-md hover:shadow-lg transition-shadow border bg-transparent border-[#6a483c] duration-300 h-48">
              <img src={dora} alt="Facial Treatment" className="w-16 h-16 object-contain rounded-md mb-2" />
              <h3 className="text-lg font-bold text-[#6a483c] mb-1">Nen Sqetulla</h3>
            </div>

            <div className="flex flex-col items-center p-2 py-8 space-y-4  shadow-md hover:shadow-lg transition-shadow border bg-transparent border-[#6a483c] duration-300 h-48">
              <img src={dora} alt="Massage Therapy" className="w-16 h-16 object-contain rounded-md mb-2" />
              <h3 className="text-lg font-bold text-[#6a483c] mb-1">Duart</h3>
            </div>

            <div className="flex flex-col items-center py-8 space-y-4 p-2 bg-transparent shadow-md hover:shadow-lg transition-shadow border border-[#6a483c] duration-300 h-48">
              <img src={legss} alt="Hair Treatment" className="w-16 h-16 object-contain rounded-md mb-2" />
        ...
        <div className="xl:w-[600px] w-full flex justify-center items-center mt-6 xl:mt-0">
          <img src={image2} alt="Treatment Image" className="xl:w-[80%] h-auto object-cover border-2 border-[#6a483c]" />
        </div>
      </div>
      <WhyChooseUs />
    </div>
